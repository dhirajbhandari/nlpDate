...
public class CalculatorParser3Test {
    private static Logger LOG = Logger.getLogger(CalculatorParser3Test.class);

    private CalculatorParser3 parser;

    @Before
    public void setUp() throws Exception {
        parser = Parboiled.createParser(CalculatorParser3.class);
    }
